          ...
          <article className="px-8 sm:px-12 text-gray-900 leading-relaxed text-lg serif-text pb-8">
            ...
            <section className="bg-gray-50 border border-gray-200 rounded-xl p-8 mb-10">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start font-sans text-base">
                  ...
                  <span className="text-gray-700">A simple process to request a quote that takes just a few minutes</span>
                </li>
                <li className="flex items-start font-sans text-base">
                  <div className="mt-1 bg-green-500 rounded-full p-0.5 mr-3 flex-shrink-0 shadow-sm">
                    <Check className="w-3.5 h-3.5 text-white" />
            ...
            <div id="quiz-anchor" className="scroll-mt-32 bg-white border-4 border-blue-600 rounded-2xl p-8 sm:p-12 font-sans shadow-2xl overflow-hidden block text-center min-h-[300px] flex flex-col justify-center">
              ...
              <p className="text-gray-400 text-xs mt-8 italic">
                Find out if you qualify for affordable term life coverage in just a few minutes.
              </p>
            </div>
          </article>
        </div>
